...
var campaign_quiz = (function () {
  ...
  */
  ...
  function add_css(target) {
    append_styles(target, "svelte-zu0zuo", ".clothing-campaign .clothing_quiz .q_items.svelte-zu0zuo .item.svelte-zu0zuo{padding-top:0;position:relative;overflow:hidden}.clothing-campaign .clothing_quiz .q_items.svelte-zu0zuo .item.svelte-zu0zuo .figure{padding-bottom:0}.clothing-campaign .clothing_quiz .q_items.svelte-zu0zuo .item.svelte-zu0zuo .figure div{padding-bottom:100%}.clothing-campaign .clothing_quiz .q_items.svelte-zu0zuo .item.svelte-zu0zuo .figure+.figure{position:absolute;width:100%;top:100%}.clothing-campaign .clothing_quiz .q_items.svelte-zu0zuo .item.svelte-zu0zuo label{padding-top:55px;width:100%}.clothing-campaign .clothing_quiz .q_items.svelte-zu0zuo .item.svelte-zu0zuo label input[type=radio]{visibility:visible;z-index:-1;opacity:0;left:50%;top:50%;transform:translate(-50%, -50%)}.clothing-campaign .clothing_quiz .q_items.svelte-zu0zuo .is-selected.svelte-zu0zuo{outline:inset 1px #B50031}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
  }
  ...
  function create_key_block(ctx) {
    ...
    var div0;
    var img0;
    var img0_style_value;
    var img0_src_value;
    var img1;
    var img1_style_value;
    var img1_src_value;
    var div0_intro;
    var div0_outro;
    var current;
    var block = {
      c: function create() {
        ...
        ctx[2]] ===
        /*index*/
        ctx[18] ? 'display:none' : 'display:block');
        if (!src_url_equal(img0.src, img0_src_value = "./care-for-what-you-wear2021/images/quiz/q" + ('0' + (
        /*currentQuiz*/
        ctx[2] + 1)).slice(-2) + "_item" + ('0' + (
        /*index*/
        ctx[18] + 1)).slice(-2) + ".png")) attr_dev(img0, "src", img0_src_value);
        add_location(img0, file, 92, 12, 2351);
        attr_dev(img1, "alt", "");
        ...
        ctx[2]] ===
        /*index*/
        ctx[18] ? 'display:block' : 'display:none');
        if (!src_url_equal(img1.src, img1_src_value = "./care-for-what-you-wear2021/images/quiz/q" + ('0' + (
        /*currentQuiz*/
        ctx[2] + 1)).slice(-2) + "_item" + ('0' + (
        /*index*/
        ctx[18] + 1)).slice(-2) + "-hover.png")) attr_dev(img1, "src", img1_src_value);
        add_location(img1, file, 96, 14, 2620);
      ...
      p: function update(ctx, dirty) {
        ...
        12 && img0_style_value !== (img0_style_value =
        /*selected*/
        ctx[3][
        /*currentQuiz*/
        ctx[2]] ===
        ...
        if (!current || dirty &
        /*currentQuiz*/
        4 && !src_url_equal(img0.src, img0_src_value = "./care-for-what-you-wear2021/images/quiz/q" + ('0' + (
        /*currentQuiz*/
        ctx[2] + 1)).slice(-2) + "_item" + ('0' + (
        /*index*/
        ctx[18] + 1)).slice(-2) + ".png")) {
          attr_dev(img0, "src", img0_src_value);
        }

        if (!current || dirty &
        /*selected, currentQuiz*/
        12 && img1_style_value !== (img1_style_value =
        /*selected*/
        ctx[3][
        /*currentQuiz*/
        ctx[2]] ===
        ...
        if (!current || dirty &
        /*currentQuiz*/
        4 && !src_url_equal(img1.src, img1_src_value = "./care-for-what-you-wear2021/images/quiz/q" + ('0' + (
        /*currentQuiz*/
        ctx[2] + 1)).slice(-2) + "_item" + ('0' + (
        /*index*/
        ctx[18] + 1)).slice(-2) + "-hover.png")) {
  ...
  function create_each_block(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(p, file, 106, 8, 2970);
        attr_dev(label, "class", "_sel");
        add_location(label, file, 86, 6, 2087);
        attr_dev(div, "class", "item svelte-zu0zuo");
  ...
  function create_if_block(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        attr_dev(a, "href", "#");
        add_location(a, file, 113, 19, 3084);
      },
      m: function mount(target, anchor) {
  ...
  function create_fragment(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        div14 = element("div");
        h41 = element("h4");
        h41.textContent = "You are Grade a Hero!";
        t37 = space();
        p6 = element("p");
        p6.textContent = "All you need now is proper LG Clothing Care Solutions to practice the tips. Oh, you already have LG products? Applause for the real master then!";
        ...
        attr_dev(div1, "class", "q_items svelte-zu0zuo");
        add_location(div1, file, 83, 0, 1925);
        attr_dev(a0, "class", "_btn btn_next");
        attr_dev(a0, "href", "#");
        add_location(a0, file, 114, 2, 3193);
        attr_dev(div2, "class", "btn_area");
        add_location(div2, file, 112, 0, 3042);
        attr_dev(button1, "class", "close_btn");
        add_location(button1, file, 120, 6, 3484);
        attr_dev(div3, "class", "layer_close");
        add_location(div3, file, 119, 4, 3452);
        add_location(h40, file, 124, 8, 3642);
        attr_dev(p1, "class", "q_tips");
        add_location(p1, file, 125, 8, 3685);
        attr_dev(span1, "class", "a11y");
        add_location(span1, file, 127, 172, 3943);
        attr_dev(p2, "class", "figure styler");
        set_style(p2, "background-image", "url('./care-for-what-you-wear2021/images/quiz/q_option4u-" +
        /*quizData*/
        ctx[0][
        /*currentQuiz*/
        ctx[2]].product.toLowerCase() + ".png')");
        add_location(p2, file, 127, 10, 3781);
        attr_dev(span2, "class", "a11y");
        add_location(span2, file, 129, 30, 4036);
        attr_dev(p3, "class", "slogan");
        add_location(p3, file, 129, 12, 4018);
        attr_dev(p4, "class", "txt");
        add_location(p4, file, 130, 12, 4102);
        add_location(div4, file, 128, 10, 4000);
        attr_dev(div5, "class", "q_option4u");
        add_location(div5, file, 126, 8, 3746);
        attr_dev(a1, "href", "#");
        attr_dev(a1, "class", "_btn btn_gray");
        add_location(a1, file, 134, 10, 4229);
        attr_dev(a2, "href", "#");
        attr_dev(a2, "class", "_btn btn_red");
        add_location(a2, file, 135, 10, 4340);
        attr_dev(div6, "class", "btn_area");
        add_location(div6, file, 133, 8, 4196);
        attr_dev(div7, "class", "layer_cont");
        add_location(div7, file, 123, 6, 3609);
        attr_dev(p5, "class", "slogan");
        add_location(p5, file, 139, 8, 4472);
        attr_dev(span3, "class", "a11y");
        add_location(span3, file, 142, 80, 4660);
        attr_dev(span4, "class", "required");
        add_location(span4, file, 142, 57, 4637);
        attr_dev(label0, "for", "UserName");
        add_location(label0, file, 142, 35, 4615);
        attr_dev(dt0, "aria-hidden", "true");
        add_location(dt0, file, 142, 12, 4592);
        attr_dev(input0, "type", "text");
        attr_dev(input0, "id", "UserName");
        attr_dev(input0, "placeholder", input0_placeholder_value =
        /*messageData*/
        ctx[1].placeholderName);
        add_location(input0, file, 143, 16, 4731);
        add_location(dd0, file, 143, 12, 4727);
        attr_dev(dl0, "class", "frm");
        add_location(dl0, file, 141, 10, 4563);
        attr_dev(span5, "class", "a11y");
        add_location(span5, file, 146, 81, 4940);
        attr_dev(span6, "class", "required");
        add_location(span6, file, 146, 58, 4917);
        attr_dev(label1, "for", "UserEmail");
        add_location(label1, file, 146, 35, 4894);
        attr_dev(dt1, "aria-hidden", "true");
        add_location(dt1, file, 146, 12, 4871);
        attr_dev(input1, "type", "email");
        attr_dev(input1, "id", "UserEmail");
        attr_dev(input1, "placeholder", input1_placeholder_value =
        /*messageData*/
        ctx[1].placeholderEmail);
        add_location(input1, file, 147, 16, 5011);
        add_location(dd1, file, 147, 12, 5007);
        attr_dev(dl1, "class", "frm");
        add_location(dl1, file, 145, 10, 4842);
        attr_dev(div8, "class", "frm_field");
        add_location(div8, file, 140, 8, 4529);
        attr_dev(div9, "class", "promo_area");
        add_location(div9, file, 138, 6, 4439);
        attr_dev(div10, "class", "layer_inner");
        add_location(div10, file, 122, 4, 3577);
        attr_dev(div11, "class", "layer_wrap");
        add_location(div11, file, 118, 2, 3423);
        attr_dev(div12, "class", "layer_body popup QzTipLayer");
        attr_dev(div12, "id", "QzTips07");
        attr_dev(div12, "aria-hidden", "true");
        attr_dev(div12, "role", "dialog");
        toggle_class(div12, "is-visible",
        /*tipsVisible*/
        ctx[4]);
        add_location(div12, file, 117, 0, 3299);
        attr_dev(button2, "class", "close_btn");
        add_location(button2, file, 158, 6, 5355);
        attr_dev(div13, "class", "layer_close");
        add_location(div13, file, 157, 4, 5323);
        add_location(h41, file, 162, 8, 5525);
        attr_dev(p6, "class", "q_tips");
        add_location(p6, file, 163, 8, 5564);
        attr_dev(div14, "class", "layer_cont qzend-box");
        add_location(div14, file, 161, 6, 5482);
        attr_dev(div15, "class", "layer_inner");
        add_location(div15, file, 160, 4, 5450);
        attr_dev(div16, "class", "layer_wrap");
        add_location(div16, file, 156, 2, 5294);
        attr_dev(div17, "class", "layer_body popup QzTipLayer");
        attr_dev(div17, "id", "QzEnd");
        attr_dev(div17, "aria-hidden", "true");
        attr_dev(div17, "role", "dialog");
        toggle_class(div17, "is-visible",
        /*masterVisible*/
        ctx[5]);
        add_location(div17, file, 155, 0, 5171);
      },
      ...
      m: function mount(target, anchor) {
        ...
        append_dev(div8, dl1);
        append_dev(dl1, dt1);
        append_dev(dt1, label1);
        append_dev(label1, span6);
        ...
        if (!mounted) {
          ...
          /*hideTips*/
          ctx[8]), false, true, false), listen_dev(a1, "click", prevent_default(
          /*hideTips*/
      ...
      p: function update(ctx, _ref) {
        ...
        /*messageData*/
        ctx[1].tipsTitle + "")) set_data_dev(t14, t14_value);
        if ((!current || dirty &
        /*quizData, currentQuiz*/
        ...
        /*messageData*/
        ctx[1].another + "")) set_data_dev(t20, t20_value);
        if ((!current || dirty &
        /*quizData, currentQuiz*/
        ...
        ctx[0][
        /*currentQuiz*/
        ctx[2]].feedback + "")) set_data_dev(t22, t22_value);
        if ((!current || dirty &
        /*messageData*/
        2) && t24_value !== (t24_value =
        /*messageData*/
        ctx[1].tryButton + "")) set_data_dev(t24, t24_value);
        if ((!current || dirty &
        /*messageData*/
        2) && t26_value !== (t26_value =
        /*messageData*/
        ctx[1].shareButton + "")) set_data_dev(t26, t26_value);
        if ((!current || dirty &
        /*messageData*/
        2) && t28_value !== (t28_value =
        /*messageData*/
        ctx[1].promoTitle + "")) set_data_dev(t28, t28_value);

        if (!current || dirty &
        /*messageData*/
        2 && input0_placeholder_value !== (input0_placeholder_value =
        /*messageData*/
        ctx[1].placeholderName)) {
          attr_dev(input0, "placeholder", input0_placeholder_value);
        }
        ...
        if (!current || dirty &
        /*messageData*/
        2 && input1_placeholder_value !== (input1_placeholder_value =
        /*messageData*/
        ctx[1].placeholderEmail)) {
          attr_dev(input1, "placeholder", input1_placeholder_value);
        }
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    var correct = [3, 3, 2, 2, 2, 3, 2, 1, 1, 3];
    var currentQuiz = 0,
    ...
    return [quizData, messageData, currentQuiz, selected, tipsVisible, masterVisible, previous, next, hideTips, hideMaster, refresh, input_change_handler, $$binding_groups];
  }
