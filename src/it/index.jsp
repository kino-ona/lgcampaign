      ...
      <div class="promotion_banner">
        ...
        <div class="promo_right">
          <div class="items">
            ...
            <p class="figure"><img src="/it/elettrodomestici/prenditi-curadei-tuoi-capi-2021/images/promo_item01.jpg" alt="	LG Lavatrice Smart AI DD™ TurboWash™ 10.5 kg Classe energetica B Lavaggio a"></p>
            <p class="model_name">
              LG Lavatrice Smart AI DD<sup>™</sup> TurboWash<sup>™</sup> 10.5 kg Classe energetica B Lavaggio a
      ...
      <div class="promotoin_product">
        ...
        <ul class="promotoin_product-list">
          ...
          <li>
            ...
            <p><a href="https://www.lg.com/it/styler/lg-S3BF" target="_blank" class="btn-more" alt="PROMOTIONAL-PRODUCTS>find-out-more">Scopri di più</a></p>
          </li>
        </ul>
      </div>
    </div>
