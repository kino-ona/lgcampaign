      ...
      <div class="layer_wrap">
        ...
        <div class="layer_inner">
          <div class="layer_cont">
            <p class="heading-tit">LG führt das Gewinnspiel<br>"My Cherished Clothes Event" auf Instagram und Facebook durch.</p>
            <p>(1)Ein LG Styler S3BF als Hauptpreis am Ende des Veranstaltungszeitraums.</p>
            <p>Die Teilnehmer müssen die unten aufgeführten Kriterien erfüllen, indem sie einen Kommentar zu den geposteten Originalinhalten mit ihren eigenen Geschichten über ein Kleidungsstück, das besondere Erinnerungen an sie weckt, posten. Bitte beachten Sie, dass nur Teilnehmer, die die unten aufgeführten Kriterien vollständig erfüllen, als Gewinner ausgewählt werden können.</p>
            <p>Aktionszeitraum: Beiträge können vom 13-Oct bis zum 2-Nov eingereicht werden. Alle Beiträge, die außerhalb dieses Zeitraums eingereicht werden, sind von der Teilnahme an dieser Aktion ausgeschlossen.</p>
            ...
            <dl>
              ...
              <dd>
                <p>Die Teilnehmer müssen einen Kommentar mit einer Geschichte über ihre Lieblingskleidung unter dem auf Instagram oder Facebook hochgeladenen Event-Post hinterlassen.</p>
              </dd>
            </dl>
            <dl>
              ...
              <dd>
                <p>Jeder Teilnehmer kann einmal mit einem Instagram- und Facebook-Post am Gewinnspiel teilnehmen, und der Gewinner wird nach dem Zufallsprinzip ausgewählt. Die Auslosung findet nach Teilnahmeschluss statt und der Gewinner wird innerhalb von 7 Tagen nach Teilnahmeschluss über Instagram oder Facebook benachrichtigt.</p>
                <p>Veranstalter: LG Electronics Deutschland GmbH, Alfred-Herrhausen-Allee 3-5, D-65760 Eschborn</p>
                <p>Kein Kauf erforderlich: Die Teilnahme an der Verlosung ist für alle Einwohner in Deutschland kostenlos, die die in diesen Teilnahmebedingungen genannten Kriterien erfüllen.</p>
              </dd>
            </dl>
            <dl>
              <dt>Teilnahmebedingungen</dt>
              <dd>
                <p>Die Teilnahme an der Verlosung ist nur für Teilnehmer mit Wohnsitz in Deutschland möglich, die mindestens 18 Jahre alt sind. Mitarbeiter von LG und allen dazugehörigen globalen Unternehmen, des Veranstalters, deren Familien und Vertreter sowie andere Unternehmen oder Personen, die an der Erstellung oder Verwaltung des Gewinnspiels beteiligt sind, sind von der Teilnahme ausgeschlossen. Ein Internetzugang, ein Facebook-Konto und ein öffentliches Instagram-Konto sind erforderlich.</p>
                <p>Indem Sie den Anweisungen des Gewinnspiels folgen, erklären Sie sich mit diesen Bedingungen und Konditionen einverstanden. Alle Entscheidungen bezüglich der Gewinner und Preise sind endgültig. LG oder der Veranstalter der Aktion führen keine Korrespondenz.</p>
                <p>Verspätete, unleserliche, unvollständige, verunstaltete oder beschädigte Beiträge sowie Beiträge, die über Agenturen und Dritte oder auf anderem Wege als über Instagram oder Facebook eingereicht werden, werden nicht akzeptiert. Für verloren gegangene Einsendungen kann keine Verantwortung übernommen werden. Wenn LG oder der Veranstalter der Meinung sind, dass ein Verstoß gegen diese Bedingungen vorliegt, sind LG oder der Veranstalter nach eigenem Ermessen berechtigt, den Preis einzubehalten und einen anderen Gewinner nach dem Zufallsprinzip in Übereinstimmung mit diesen Bedingungen zu ziehen.</p>
                <p>Der Gewinner wird nach seiner Auswahl vom Veranstalter per Instagram- oder Facebook-Direktnachricht kontaktiert und um seine Kontaktdaten gebeten (siehe Punkt 9). Es liegt in der Verantwortung des Gewinners, sicherzustellen, dass die von ihm angegebenen Daten korrekt sind. Weder der Veranstalter noch der Organisator sind für eine fehlgeschlagene Lieferung verantwortlich, wenn die Teilnehmer falsche oder unvollständige Lieferinformationen angegeben haben oder die Lieferung nicht wie erforderlich unterzeichnet haben.</p>
              </dd>
            </dl>
            <dl>
              <dt>Auswahlverfahren:<br>Der Gewinner des Preises wird vom Veranstalter nach dem Zufallsprinzip ausgewählt. </dt>
              <dd>
                <p>Der Gewinner wird innerhalb von sieben (7) Tagen nach Ende des Gewinnspiels ausgelost. Der Gewinner wird nach seiner Auswahl vom Veranstalter per Instagram- oder Facebook-Direktnachricht kontaktiert und um seine Kontaktdaten gebeten. Der Gewinner wird gebeten, die relevanten Kontaktdaten anzugeben, einschließlich, aber nicht beschränkt auf seine E-Mail-Adresse, Telefonnummer und Adresse, um dem Gewinner die Preise zuzusenden.</p>
                ...
                <p>Teilnehmer sind einverstanden, dass sie sich an Werbemaßnahmen von LG im Zusammenhang mit dem Gewinnspiel beteiligen. Der Name des Teilnehmers kann auf LG.com und/oder den sozialen Medien von LG veröffentlicht werden. Dies kann auch Bilder einschließen, die der Nutzer im Rahmen der Werbeaktion einreicht.</p>
                <p>LG ist nicht verpflichtet, seinen Verpflichtungen im Rahmen des Gewinnspiels oder in Bezug auf den Preis nachzukommen, wenn dies aufgrund von unvorhergesehenen Umständen oder Umständen, die außerhalb der Kontrolle von LG liegen, nicht möglich ist. Obwohl LG sich bemühen kann (aber nicht verpflichtet ist), einen alternativen Preis von gleichem Wert bereitzustellen, ist LG nicht verpflichtet, den Gewinnern unter solchen Umständen eine zusätzliche Entschädigung zu zahlen.</p>
                <p>Sollte der Veranstalter nicht in der Lage sein, den Gewinner in angemessener Weise zu kontaktieren, oder sollte der Gewinner nicht innerhalb von drei (3) Tagen nach der ersten Nachricht auf Kontaktversuche reagieren, oder sollte der Gewinner nicht in der Lage sein, den Preis anzunehmen, verfällt der Preis und der Veranstalter behält sich das Recht vor, den Preis an einen anderen Gewinner zu vergeben, der in Übereinstimmung mit diesen Bedingungen ausgelost wird.</p>
              </dd>
            </dl>
            <dl>
              <dt>Kein Umtausch:<br>Der Preis ist nicht übertragbar und kann nicht gegen Bargeld oder eine andere Alternative eingetauscht werden. Der Preis ist abhängig von der Verfügbarkeit und LG behält sich das Recht vor, den Preis jederzeit zu ändern.</dt>
              <dd>
                <p>LG handelt als für die Datenverarbeitung Verantwortlicher im Sinne der Datenschutzgesetze (einschließlich des Data Protection Act 2018 und gegebenenfalls der Allgemeinen Datenschutzverordnung). LG verpflichtet sich, seine Verpflichtungen gemäß den Datenschutzgesetzen einzuhalten. Insbesondere werden LG und/oder der Veranstalter alle personenbezogenen Daten sicher aufbewahren und ausschließlich für die Zwecke der Verwaltung des Gewinnspiels gemäß diesen Teilnahmebedingungen und in Übereinstimmung mit dem CAP-Kodex verwenden. Weitere Informationen über die Datenschutzbestimmungen von LG finden Sie unter https://www.lg.com/de/privacy.</p>
              </dd>
            </dl>
            <dl>
              <dt>Haftung:<br>Abgesehen von jeglicher Haftung, die gesetzlich nicht ausgeschlossen werden kann, kann LG keine Verantwortung für Schäden, Verluste, Verletzungen oder Enttäuschungen übernehmen, die ein Teilnehmer infolge der Teilnahme an dem Gewinnspiel erleidet.</dt>
            </dl>
            <dl>
            ...
            <dl>
              <dt>Geltendes Recht:<br>Das Werbegeschenk unterliegt den Gesetzen von der Bundesrepublik Deutschland und die Gerichte der Bundesrepublik Deutschland haben die ausschließliche Zuständigkeit für die Entscheidung von Streitigkeiten, die sich aus, unter oder in Verbindung mit dem Werbegeschenk ergeben können.</dt>
            </dl>
          </div>
        </div>
      </div>
