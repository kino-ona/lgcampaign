      ...
      <div class="promotion_banner">
        ...
        <div class="promo_right">
          <div class="items">
            ...
            <p class="figure"><img src="/es/electrodomesticos/cuida-tu-ropa-2021/images/promo_item01.jpg" alt="Lavadora inteligente AI Direct Drive 10,5kg, 1400rpm, Clasificación B, Blanca, Serie 700"></p>
            <p class="model_name">
              Lavadora inteligente AI Direct Drive 10,5kg, 1400rpm, Clasificación B, Blanca, Serie 700
          ...
          <div class="items">
            <span class="tagg"><img src="/es/electrodomesticos/cuida-tu-ropa-2021/images/promo_tag.png" alt="special offer"></span>
            <p class="figure"><img src="/es/electrodomesticos/cuida-tu-ropa-2021/images/promo_item02.jpg" alt="Lavadora inteligente AI Direct Drive 8,5kg, 1200rpm, Clasificación C, Blanca, Serie 300"></p>
            <p class="model_name">
              Lavadora inteligente AI Direct Drive 8,5kg, 1200rpm, Clasificación C, Blanca, Serie 300
          ...
          <div class="items">
            <span class="tagg"><img src="/es/electrodomesticos/cuida-tu-ropa-2021/images/promo_tag.png" alt="special offer"></span>
            <p class="figure"><img src="/es/electrodomesticos/cuida-tu-ropa-2021/images/promo_item03.jpg" alt="Lavasecadora inteligente AI Direct Drive 9/6kg, 1400rpm, Clasificación E, Blanca, Serie 500"></p>
            <p class="model_name">
              Lavasecadora inteligente AI Direct Drive 9/6kg, 1400rpm, Clasificación E, Blanca, Serie 500
          ...
          <div class="items">
            <span class="tagg"><img src="/es/electrodomesticos/cuida-tu-ropa-2021/images/promo_tag.png" alt="special offer"></span>
            <p class="figure"><img src="/es/electrodomesticos/cuida-tu-ropa-2021/images/promo_item04.jpg" alt="Secadora con Bomba de calor Dual Inverter 8kg, Clasificación A+++, Blanca, Serie 5."></p>
            <p class="model_name">
              Secadora con Bomba de calor Dual Inverter 8kg, Clasificación A+++, Blanca, Serie 5.
