          ...
          <div class="box_view-detail">
            <div id="washer" class="box_view-item box_view-item1 active">
              <div class="figure">
                ...
                <div class="btn_area">
                  <a href="https://www.lg.com/uk/washing-machines/lg-f4v1112wtsa" adobe-click="clothing-care-campaign-main-washer" adobe-value="main>product-feature>washer>buy-now" data-link-name="buy_now" target="_blank" class="_btn btn_red">BUY NOW</a>
                </div>
              </div>
              <div class="desc">
            ...
            <div id="dryer" class="box_view-item box_view-item2">
              <div class="figure">
                ...
                <div class="btn_area">
                  <a href="https://www.lg.com/uk/tumble-dryers/lg-fdv1109w" adobe-click="clothing-care-campaign-main-dryer" adobe-value="main>product-feature>washer>buy-now" data-link-name="buy_now" target="_blank" class="_btn btn_red">BUY NOW</a>
                </div>
              </div>
              <div class="desc">
                <dl class="_item item01">
