...
$('.clothing-campaign .btn_watch').on('click', function(){
	...
	if($(this).data("type") == 'vodtype') {
		...
		$('.clothing-campaign .pop_vodframe-inner').find('.movie-box').append('<video class="vodframe" muted="muted" loop onloadedmetadata="this.muted = true" poster="" playsinline><source src="/de/haushaltsgeraete/care-for-what-you-wear-2021/images/'+movieCode+'.mp4" type="video/mp4" autostart="false"></video>');
...
function facebookSubmit(set) {
	var thisurl = 'https://www.lg.com//de/haushaltsgeraete/care-for-what-you-wear-2021/images/ogimage.jpg';
	var quote = 'https://www.lg.com//de/haushaltsgeraete/care-for-what-you-wear-2021/';
	...
	eventName = 'quiz_event_facebook_share_click';
	micrositeName = 'care-for-what-you-wear';
	dataLayer.push({
		'event' : eventName,
		'datalinkname': 'quiz_event_facebook_share',
