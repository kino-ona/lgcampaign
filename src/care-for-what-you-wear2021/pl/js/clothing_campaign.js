...
$('.clothing-campaign .btn_watch').on('click', function(){
	...
	if($(this).data("type") == 'vodtype') {
		...
		$('.clothing-campaign .pop_vodframe-inner').find('.movie-box').append('<video class="vodframe" muted="muted" loop onloadedmetadata="this.muted = true" poster="" playsinline><source src="/pl/sprzet-agd/zadbaj-o-to-co-nosisz-2021/images/'+movieCode+'.mp4" type="video/mp4" autostart="false"></video>');
