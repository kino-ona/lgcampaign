...
var campaign_quiz = (function () {
  ...
  */
  ...
  function get_each_context(ctx, list, i) {
    ...
    child_ctx[19] = i;
    return child_ctx;
  } // (68:2) {#each quizData[currentQuiz].answers as answer, index}
  ...
  function create_each_block(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        ctx[12][0].push(input);
        add_location(input, file, 70, 8, 1564);
        attr_dev(img, "alt", "");
        if (!src_url_equal(img.src, img_src_value = "./care-for-what-you-wear2021/images/quiz/q" + ('0' + (
        /*currentQuiz*/
        ...
        ctx[3] ===
        /*index*/
        ctx[19] ? '-hover' : '') + ".png")) attr_dev(img, "src", img_src_value);
        add_location(img, file, 72, 10, 1676);
        attr_dev(p0, "class", "figure");
        add_location(p0, file, 71, 8, 1647);
        attr_dev(p1, "class", "txt");
        add_location(p1, file, 80, 8, 1950);
        attr_dev(label, "class", "_sel");
        add_location(label, file, 69, 6, 1484);
        attr_dev(div, "class", "item");
        add_location(div, file, 68, 4, 1459);
      },
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          ...
          ctx[11]), listen_dev(label, "click", prevent_default(click_handler), false, true, false)];
          mounted = true;
        }
      },
      p: function update(new_ctx, dirty) {
        ...
        12 && !src_url_equal(img.src, img_src_value = "./care-for-what-you-wear2021/images/quiz/q" + ('0' + (
        /*currentQuiz*/
        ctx[2] + 1)).slice(-2) + "_item" + ('0' + (
        /*index*/
        ctx[19] + 1)).slice(-2) + (
        ...
        5 && t2_value !== (t2_value =
        /*answer*/
        ctx[17] + "")) set_data_dev(t2, t2_value);
      },
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "each",
      source: "(68:2) {#each quizData[currentQuiz].answers as answer, index}",
      ctx: ctx
    });
    return block;
  } // (88:2) {#if currentQuiz}
  ...
  function create_if_block(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        attr_dev(a, "href", "#");
        add_location(a, file, 87, 19, 2064);
      },
      m: function mount(target, anchor) {
  ...
  function create_fragment(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(span0, file, 62, 64, 1195);
        attr_dev(button0, "class", "btn_refresh");
        add_location(button0, file, 62, 0, 1131);
        add_location(strong, file, 63, 20, 1258);
        attr_dev(div0, "class", "q_step");
        add_location(div0, file, 63, 0, 1238);
        attr_dev(p0, "class", "q_title");
        add_location(p0, file, 64, 0, 1319);
        attr_dev(div1, "class", "q_items");
        add_location(div1, file, 66, 0, 1376);
        attr_dev(a0, "class", "_btn btn_next");
        attr_dev(a0, "href", "#");
        add_location(a0, file, 88, 2, 2173);
        attr_dev(div2, "class", "btn_area");
        add_location(div2, file, 86, 0, 2022);
        attr_dev(button1, "class", "close_btn");
        add_location(button1, file, 94, 6, 2464);
        attr_dev(div3, "class", "layer_close");
        add_location(div3, file, 93, 4, 2432);
        add_location(h40, file, 98, 8, 2622);
        attr_dev(p1, "class", "q_tips");
        add_location(p1, file, 99, 8, 2665);
        attr_dev(span1, "class", "a11y");
        add_location(span1, file, 101, 172, 2923);
        ...
        add_location(p2, file, 101, 10, 2761);
        attr_dev(span2, "class", "a11y");
        add_location(span2, file, 103, 30, 3016);
        attr_dev(p3, "class", "slogan");
        add_location(p3, file, 103, 12, 2998);
        attr_dev(p4, "class", "txt");
        add_location(p4, file, 104, 12, 3082);
        add_location(div4, file, 102, 10, 2980);
        attr_dev(div5, "class", "q_option4u");
        add_location(div5, file, 100, 8, 2726);
        attr_dev(a1, "href", "#");
        attr_dev(a1, "class", "_btn btn_gray");
        add_location(a1, file, 108, 10, 3209);
        attr_dev(a2, "href", "#");
        attr_dev(a2, "class", "_btn btn_red");
        add_location(a2, file, 109, 10, 3320);
        attr_dev(div6, "class", "btn_area");
        add_location(div6, file, 107, 8, 3176);
        attr_dev(div7, "class", "layer_cont");
        add_location(div7, file, 97, 6, 2589);
        attr_dev(p5, "class", "slogan");
        add_location(p5, file, 113, 8, 3452);
        attr_dev(span3, "class", "a11y");
        add_location(span3, file, 116, 80, 3640);
        attr_dev(span4, "class", "required");
        add_location(span4, file, 116, 57, 3617);
        attr_dev(label0, "for", "UserName");
        add_location(label0, file, 116, 35, 3595);
        attr_dev(dt0, "aria-hidden", "true");
        add_location(dt0, file, 116, 12, 3572);
        attr_dev(input0, "type", "text");
        attr_dev(input0, "id", "UserName");
        attr_dev(input0, "placeholder", input0_placeholder_value =
        /*messageData*/
        ctx[1].placeholderName);
        add_location(input0, file, 117, 16, 3711);
        add_location(dd0, file, 117, 12, 3707);
        attr_dev(dl0, "class", "frm");
        add_location(dl0, file, 115, 10, 3543);
        attr_dev(span5, "class", "a11y");
        add_location(span5, file, 120, 81, 3920);
        attr_dev(span6, "class", "required");
        add_location(span6, file, 120, 58, 3897);
        attr_dev(label1, "for", "UserEmail");
        add_location(label1, file, 120, 35, 3874);
        attr_dev(dt1, "aria-hidden", "true");
        add_location(dt1, file, 120, 12, 3851);
        attr_dev(input1, "type", "email");
        attr_dev(input1, "id", "UserEmail");
        attr_dev(input1, "placeholder", input1_placeholder_value =
        /*messageData*/
        ctx[1].placeholderEmail);
        add_location(input1, file, 121, 16, 3991);
        add_location(dd1, file, 121, 12, 3987);
        attr_dev(dl1, "class", "frm");
        add_location(dl1, file, 119, 10, 3822);
        attr_dev(div8, "class", "frm_field");
        add_location(div8, file, 114, 8, 3509);
        attr_dev(div9, "class", "promo_area");
        add_location(div9, file, 112, 6, 3419);
        attr_dev(div10, "class", "layer_inner");
        add_location(div10, file, 96, 4, 2557);
        attr_dev(div11, "class", "layer_wrap");
        add_location(div11, file, 92, 2, 2403);
        ...
        /*tipsVisible*/
        ctx[4]);
        add_location(div12, file, 91, 0, 2279);
        attr_dev(button2, "class", "close_btn");
        add_location(button2, file, 132, 6, 4335);
        attr_dev(div13, "class", "layer_close");
        add_location(div13, file, 131, 4, 4303);
        add_location(h41, file, 136, 8, 4505);
        attr_dev(p6, "class", "q_tips");
        add_location(p6, file, 137, 8, 4544);
        attr_dev(div14, "class", "layer_cont qzend-box");
        add_location(div14, file, 135, 6, 4462);
        attr_dev(div15, "class", "layer_inner");
        add_location(div15, file, 134, 4, 4430);
        attr_dev(div16, "class", "layer_wrap");
        add_location(div16, file, 130, 2, 4274);
        ...
        /*masterVisible*/
        ctx[5]);
        add_location(div17, file, 129, 0, 4151);
      },
      ...
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          ...
          /*refresh*/
          ctx[9]), false, true, false), listen_dev(a0, "click", prevent_default(
          /*next*/
          ctx[6]), false, true, false), listen_dev(button1, "click", prevent_default(
          /*hideTips*/
          ctx[7]), false, true, false), listen_dev(a1, "click", prevent_default(
          /*hideTips*/
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    function next() {
      ...
      if ((correct[currentQuiz] - 1).toString() === selected.toString()) {
    ...
    return [quizData, messageData, currentQuiz, selected, tipsVisible, masterVisible, next, hideTips, hideMaster, refresh, previous, input_change_handler, $$binding_groups, click_handler];
  }
